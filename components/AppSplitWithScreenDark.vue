<template>
      ...
      <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        ...
        <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
          <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <img src="https://res.cloudinary.com/drra3biar/image/upload/v1702447515/Beige_Grey_Minimalist_Aesthetic_Simple_Grid_Photo_Collage_owr5rd.png" alt="App screenshot" width="2432" height="1442" class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10" />
          </div>
        </div>
      </div>
    </div>
  ...
  const submitHandler = async (formData) => {
    const { data: email, refresh } = await useAsyncData( 'post', () => 
     $fetch('/api/hello') )

...
/**
  ...
  *
  * @checksum - 199704c2d49b0953ea9911f27ac5f26663ebd9dd4316645daabf619aa5de3a53
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=2.5,scale=lg,inputShadow=shadow-lg,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
